...
export default function WorkoutList({
  ...
  return (
    <View style={[GLOBAL_STYLES.pageContainer, { paddingHorizontal: 10 }]}>
       <Text style ={{fontSize:30,color:"white",textAlign:"center",padding:20}} >Workout List</Text>
       <Text style ={{fontSize:15,color:"white",textAlign:"center",padding:10}} >You can create and track your workouts here</Text>
      <Button
        onPress={addWorkout}
        title="Add Workout"
        buttonStyle={{ backgroundColor: GLOBAL_STYLES.COLORS.foreground,borderRadius:10 }}
