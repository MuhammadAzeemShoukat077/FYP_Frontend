...
export default function ExerciseList({ exerciseList, setExerciseList }) {
  ...
  return (
    <View style={GLOBAL_STYLES.pageContainer}>
     <Text style ={{fontSize:30,color:"white",textAlign:"center",padding:20}} >Exercises List</Text>
     <Text style ={{fontSize:15,color:"white",textAlign:"center",padding:10}} >Add your favorite exercises here</Text>
      <Button
        type="clear"
